...
export const useActions = ({ permissions, id }: UseActionsProps) => {
    // const { mutate: hideApplication } = useHideApplicationMutation();
    // const { mutate: editApplication } = useEditApplicationMutation();
    // const { mutate: removeFromCollection } = useRemoveFromCollectionMutation();
